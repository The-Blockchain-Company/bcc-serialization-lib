...
pub struct TransactionWitnessSet {
    ...
    zerepoch_data: Option<ZerepochList>,
...
impl TransactionWitnessSet {
    ...
    pub fn set_zerepoch_data(&mut self, zerepoch_data: &ZerepochList) {
        self.zerepoch_data = Some(zerepoch_data.clone())
    }

    pub fn zerepoch_data(&self) -> Option<ZerepochList> {
        self.zerepoch_data.clone()
    }
...
pub enum ScriptHashNamespace {
    NativeScript,
    // TODO: do we need to update this for Zerepoch?
}
